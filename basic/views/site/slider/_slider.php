...
echo Html::beginTag('div',['class' => 'image-slider']);
	echo Html::img('@web/images/slider/roll/1/1.jpg',['class' => 'img-responsive', 'status' => 'active', 'slider' => '1']);
    echo Html::img('@web/images/slider/roll/1/2.jpg',['class' => 'img-responsive visible', 'status' => 'pending', 'slider' => '1']);
    
    echo Html::img('@web/images/slider/roll/1/3.jpg',['class' => 'img-responsive visible', 'status' => 'active', 'slider' => '1']);  
    echo Html::img('@web/images/slider/roll/1/4.jpg',['class' => 'img-responsive visible', 'status' => 'pending', 'slider' => '1']);  
